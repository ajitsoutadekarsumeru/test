...
{
    public class MasterImportPartiallyProcessedEmailNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public virtual void ConstructData(MasterFileStatusDtoWithId _dto, int recordsinserted, int recordsupdated, int nooferrorrecords, int totalrecords)
        {
            EmailMessage = "<p>Hi,<br/>" +
                       "<p> " + _dto.UploadType + " Import file uploaded and processed Partially successfully.<br/>" +
