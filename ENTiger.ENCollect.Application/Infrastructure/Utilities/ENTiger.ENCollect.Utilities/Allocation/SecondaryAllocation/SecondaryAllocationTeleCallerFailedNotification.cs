...
{
    public class SecondaryAllocationTeleCallerFailedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public SecondaryAllocationTeleCallerFailedNotification(IOptions<NotificationSettings> notificationSettings)
        {
        ...
        public virtual void ConstructData(string WorkRequestId)
        {
            ...
            + "Note the correct headers should be : AccountNo & Tele Caller Code & AllocationExpireDate without any double quotes or spaces.<br>"
