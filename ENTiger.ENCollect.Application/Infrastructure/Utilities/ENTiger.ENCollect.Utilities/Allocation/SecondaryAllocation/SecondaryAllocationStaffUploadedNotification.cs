...
{
    public class SecondaryAllocationStaffUploadedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public SecondaryAllocationStaffUploadedNotification(IOptions<NotificationSettings> notificationSettings)
        {
