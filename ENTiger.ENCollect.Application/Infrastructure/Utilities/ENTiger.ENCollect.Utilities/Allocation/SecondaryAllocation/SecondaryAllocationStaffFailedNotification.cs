...
{
    public class SecondaryAllocationStaffFailedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public SecondaryAllocationStaffFailedNotification(IOptions<NotificationSettings> notificationSettings)
        {
        ...
        public virtual void ConstructData(string WorkRequestId)
        {
            ...
            + "Note the correct headers should be : AccountNo & CollectorCode & AllocationExpireDate  without any double quotes or spaces.<br>"
            + "Regards <br>"
            + Signature + "<br>"
