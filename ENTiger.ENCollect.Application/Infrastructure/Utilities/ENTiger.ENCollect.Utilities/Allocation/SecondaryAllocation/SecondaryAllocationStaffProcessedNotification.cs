...
{
    public class SecondaryAllocationStaffProcessedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Allocation Owner Secondary Batch Upload - " + TransactionId;
