...
{
    public class SecondaryAllocationAgentProcessedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Agency Secondary Batch Upload - " + TransactionId;
