...
{
    public class SecondaryAllocationTeleCallerProcessedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Tele Caler Secondary Batch Upload - " + TransactionId;
