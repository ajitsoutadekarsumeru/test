...
{
    public class SecondaryAllocationTeleCallerUploadedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public SecondaryAllocationTeleCallerUploadedNotification(IOptions<NotificationSettings> notificationSettings)
        {
