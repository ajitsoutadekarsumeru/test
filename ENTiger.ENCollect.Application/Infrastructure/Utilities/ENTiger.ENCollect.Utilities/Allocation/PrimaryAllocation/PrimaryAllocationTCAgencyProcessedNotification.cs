...
{
    public class PrimaryAllocationTCAgencyProcessedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Tele Calling Agency Primary Batch Upload - " + TransactionId;
