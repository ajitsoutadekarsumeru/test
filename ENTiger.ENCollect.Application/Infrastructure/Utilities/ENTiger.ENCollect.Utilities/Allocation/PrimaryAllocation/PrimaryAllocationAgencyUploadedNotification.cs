...
{
    public class PrimaryAllocationAgencyUploadedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public PrimaryAllocationAgencyUploadedNotification(IOptions<NotificationSettings> notificationSettings)
        {
