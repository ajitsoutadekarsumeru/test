...
{
    public class PrimaryAllocationOwnerProcessedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Allocation Owner Primary Batch Upload - " + TransactionId;
