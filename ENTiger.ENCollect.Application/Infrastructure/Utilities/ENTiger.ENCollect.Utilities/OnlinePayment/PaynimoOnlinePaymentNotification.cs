...
{
    public class PaynimoOnlinePaymentNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public PaynimoOnlinePaymentNotification(IOptions<NotificationSettings> notificationSettings)
        {
        ...
        public virtual void ConstructData(CollectionDtoWithId _dto, PaymentTransactionDtoWithId result)
        {
            ...
            if (!string.IsNullOrEmpty(_dto.MobileNo) && string.Equals(result.PaymentGateway.ReturnURL, "success", StringComparison.OrdinalIgnoreCase))
            {
                if (_dto.Account != null)
                {
                    ...
                    SMSMessage = "Dear " + _dto.CustomerName.Replace(" ", "") + ", You can now pay your amount of "
                        ...
                        + result.PaymentGateway.ReturnURL + ". Thanks " + SMSSignature + "";
                    ...
                    WAMessage = "Dear " + _dto.CustomerName + ", You can now pay amount of "
                        + _dto.Amount + " for your vistaar loan account number "
                        + _dto.Account.CustomId + " using the below link for online payment. "
                        + result.PaymentGateway.ReturnURL + " .";
                ...
                {
                    var message = "Dear " + _dto.CustomerName.Replace(" ", "") + " ,You can now pay your overdue amount of " + _dto.Amount + " for your account number XXXX using the below link for online payment." + result.PaymentGateway.ReturnURL + " Regards, My Bank";

                    EmailSubject = "Pay your My Bank Online";
                    EmailMessage = "<p>Dear " + _dto.CustomerName.Replace(" ", "") + ",</p><br/><p> You can now pay your overdue amount of  " + _dto.Amount + " for your account number XXXX using the below link for online payment.</p><br/><a href=" + result.PaymentGateway.ReturnURL + "> Click Here</a>";
