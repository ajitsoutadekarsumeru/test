...
{
    public class BulkCreateAgencyFailedEmailNotification : IMessageTemplate, IFlexUtilityService
    {
        public string EmailSubject { get; set; } = string.Empty;
        public string EmailMessage { get; set; } = string.Empty;
        public string SMSMessage { get; set; } = string.Empty;
        private readonly NotificationSettings _notificationSettings;
        public BulkCreateAgencyFailedEmailNotification(IOptions<NotificationSettings> notificationSettings)
        {
        ...
        public virtual void ConstructData(string TransactionId)
        {
            ...
            EmailSubject = "Bulk Upload of Agency -" + TransactionId;
