...
{
    public class AgencyUserDormantManagerEmailNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public AgencyUserDormantManagerEmailNotification(IOptions<NotificationSettings> notificationSettings)
        {
            _notificationSettings = notificationSettings.Value;
        }

        public virtual void ConstructData(AgencyUserDto _dto, int InactiveDays, string ManagerFirstName)
        {
