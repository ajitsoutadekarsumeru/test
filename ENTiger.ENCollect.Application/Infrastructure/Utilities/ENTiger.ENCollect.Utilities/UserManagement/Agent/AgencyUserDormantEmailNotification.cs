...
{
    public class AgencyUserDormantEmailNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public AgencyUserDormantEmailNotification(IOptions<NotificationSettings> notificationSettings)
        {
            _notificationSettings = notificationSettings.Value;
        }

        public virtual void ConstructData(AgencyUserDto _dto, int InactiveDays)
        {
