...
{
    public class SecondaryUnAllocationUploadedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Bulk Secondary UnAllocation Upload -" + TransactionId;
