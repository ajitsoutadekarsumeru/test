...
{
    public class CollectionCancellationRejectedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public CollectionCancellationRejectedNotification(IOptions<NotificationSettings> notificationSettings)
        {
        ...
        public virtual void ConstructData(CollectionDtoWithId _dto)
        {
            ...
            SMSMessage = "Cancellation requested for eReceipt Number "
                + _dto.CustomId + ", Received Rs. "
                + _dto.Amount + " by "
                + _dto.CollectionMode + " vide towards Loan A / c No. "
                + _dto.Account.CustomId + " is REJECTED. Thanks "
                + SMSSignature + "";
            ...
            EmailMessage =
                    "<p>CANCELLATION EMAIL: Receipt No. " + _dto.CustomId + "</p><br/>" +
                       ...
                       + _dto.Account.CustomId + " is REJECTED. <br/>" +
                       "<b>Receiving Agent Name:</b> " + _dto.Collector.FirstName + " "
                       + _dto.Collector.LastName + ".<br/>" +
