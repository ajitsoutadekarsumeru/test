...
{
    public class IssueReceiptNotificationRTGS : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            DateTime dt = Convert.ToDateTime(_dto.CollectionDate);
            string PaymentDates = dt.ToString("dd/M/yyyy");
            ...
            try
            {
                EmailMessage =
                  " <p>Receipt No. " + _dto.CustomId + "</p><br/>" +
                        ...
                        // "<b>Agency Name:</b> " + _dto.CollectionOrg.FirstName + ".<br/>" +
