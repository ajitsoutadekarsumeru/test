...
{
    public class CollectionCancellationRequestedNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        public CollectionCancellationRequestedNotification(IOptions<NotificationSettings> notificationSettings)
        {
        ...
        public virtual void ConstructData(CollectionDtoWithId _dto)
        {
            ...
            SMSMessage = "Dear " + _dto.Collector.FirstName + ", " + _dto.Collector.LastName
                + " Cancellation is requested for eReceipt Number "
                + _dto.CustomId + " Rs. " + _dto.Amount + " by "
                + _dto.CollectionMode + " towards Loan A / c No. "
                + _dto.Account.CustomId + " Thanks "
                + SMSSignature + "";
            ...
            EmailMessage =
                    ...
                    "<p>" +
                    "eReceipt Number " + _dto.CustomId + " issued towards payment of Rs. "
                    + _dto.Amount + " by " + _dto.CollectionMode + " under your Loan Account No. "
