...
{
    public class ImportAccountsViaAPIPartialNotification : IMessageTemplate, IFlexUtilityService
    {
        ...
        {
            EmailSubject = "Partially Processed : Confirmation of Accounts Import via API - " + TransactionId;
