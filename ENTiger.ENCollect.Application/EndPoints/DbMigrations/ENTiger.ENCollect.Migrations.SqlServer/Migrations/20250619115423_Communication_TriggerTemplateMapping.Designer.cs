...
namespace ENTiger.ENCollect.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20250619115423_Communication_TriggerTemplateMapping")]
    partial class Communication_TriggerTemplateMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENTiger.ENCollect.AccountScopeConfiguration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6103), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6147), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6161), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6162), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6168), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6169), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6178), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 19, 17, 24, 16, 818, DateTimeKind.Unspecified).AddTicks(6179), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        });
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTrigger", b =>
                {
                    ...
                    b.Property<string>("CommunicationTriggerTypeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.HasIndex("CommunicationTriggerTypeId");

                    b.ToTable("CommunicationTrigger");
                });

            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTriggerType", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.ToTable("CommunicationTriggerType");
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTrigger", b =>
                {
                    b.HasOne("ENTiger.ENCollect.CommunicationTriggerType", "CommunicationTriggerType")
                        .WithMany("Triggers")
                        .HasForeignKey("CommunicationTriggerTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CommunicationTriggerType");
                });
