...
namespace ENTiger.ENCollect.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20250403112325_LatestAllocationDateFieldAdded")]
    partial class LatestAllocationDateFieldAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENTiger.ENCollect.DispositionCodeMaster", b =>
                {
                    ...
                    b.Property<string>("DispositionCodeCustomerOrAccountLevel")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.RoleAccountScope", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3272), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3330), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3355), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3360), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3378), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3382), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3425), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 4, 3, 16, 53, 20, 868, DateTimeKind.Unspecified).AddTicks(3429), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        });
                });
