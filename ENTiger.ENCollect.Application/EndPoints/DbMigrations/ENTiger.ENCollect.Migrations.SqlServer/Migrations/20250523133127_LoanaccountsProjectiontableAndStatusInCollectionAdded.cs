        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanAccountId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    TotalCollectionAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    CurrentDispositionGroup = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CurrentDispositionCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CurrentDispositionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CurrentNextActionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PreviousDispositionGroup = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PreviousDispositionCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PreviousDispositionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PreviousNextActionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
