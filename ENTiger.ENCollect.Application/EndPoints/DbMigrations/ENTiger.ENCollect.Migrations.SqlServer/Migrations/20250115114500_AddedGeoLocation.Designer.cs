...
namespace ENTiger.ENCollect.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20250115114500_AddedGeoLocation")]
    partial class AddedGeoLocation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ENTiger.ENCollect.Collection", b =>
                {
                    ...
                    b.Property<DateOnly?>("Created_DateOnly")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("date")
                        .HasComputedColumnSql("CAST(CreatedDate AS DATE)", true);
                    ...
                    b.HasIndex("Created_DateOnly")
                        .HasDatabaseName("IX_Collections_Created_DateOnly");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.Feedback", b =>
                {
                    ...
                    b.HasIndex("Created_DateOnly")
                        .HasDatabaseName("IX_Feedback_Created_DateOnly");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.UserAttendanceLog", b =>
                {
                    ...
                    b.HasIndex("Created_DateOnly")
                        .HasDatabaseName("IX_UserAttendanceLog_Created_DateOnly");
