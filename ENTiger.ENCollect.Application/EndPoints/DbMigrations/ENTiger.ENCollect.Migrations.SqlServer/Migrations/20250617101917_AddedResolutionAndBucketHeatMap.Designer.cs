...
namespace ENTiger.ENCollect.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20250617101917_AddedResolutionAndBucketHeatMap")]
    partial class AddedResolutionAndBucketHeatMap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENTiger.ENCollect.AccountScopeConfiguration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9657), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9702), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9711), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9712), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9717), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9718), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9727), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 17, 15, 49, 13, 254, DateTimeKind.Unspecified).AddTicks(9728), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        });
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.BucketHeatMapConfig", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.Property<string>("ResolutionMasterId")
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.HasIndex("ResolutionMasterId");

                    b.ToTable("BucketHeatMapConfig");
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTemplate", b =>
                {
                    ...
                    b.Property<bool>("IsAllowAccessFromAccountDetails")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.BucketHeatMapConfig", b =>
                {
                    b.HasOne("ENTiger.ENCollect.Bucket", "Bucket")
                        .WithMany()
                        .HasForeignKey("BucketId");

                    b.HasOne("ENTiger.ENCollect.Resolution", "ResolutionMaster")
                        .WithMany()
                        .HasForeignKey("ResolutionMasterId");

                    b.Navigation("Bucket");

                    b.Navigation("ResolutionMaster");
                });
