...
namespace ENTiger.ENCollect.Migrations.MySql.Migrations
{
    ...
    partial class ApplicationEFDbMigrationContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENTiger.ENCollect.AccountScopeConfiguration", b =>
            {
                ...
                b.HasData(
                    new
                    {
                        ...
                        CreatedDate = new DateTimeOffset(new DateTime(2025, 7, 14, 15, 20, 29, 245, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                        IsDeleted = false,
                        LastModifiedDate = new DateTimeOffset(new DateTime(2025, 7, 14, 15, 20, 29, 245, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                        Scope = "all",
                        ScopeLevel = 1
                    },
                    new
            ...
            modelBuilder.Entity("ENTiger.ENCollect.Communication", b =>
            {
                b.Property<string>("Id")
                    .HasMaxLength(32)
                    .HasColumnType("varchar(32)");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.TriggerAccountQueueProjection", b =>
            {
                b.Property<string>("Id")
                    .HasMaxLength(32)
                    .HasColumnType("varchar(32)");
                ...
                b.ToTable("TriggerAccountQueueProjection");
            });

            modelBuilder.Entity("ENTiger.ENCollect.TriggerDeliverySpec", b =>
            {
                b.Property<string>("Id")
                    .HasMaxLength(32)
                    .HasColumnType("varchar(32)");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.TriggerType", b =>
            {
                ...
                b.Property<string>("OffsetBasis")
                    .HasMaxLength(50)
                    .HasColumnType("varchar(50)");

                b.Property<string>("OffsetDirection")
                    .HasMaxLength(50)
                    .HasColumnType("varchar(50)");

                b.Property<bool>("RequiresDaysOffset")
                    .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.TriggerAccountQueueProjection", b =>
            {
                ...
                b.HasOne("ENTiger.ENCollect.CommunicationTrigger", "Trigger")
                    .WithMany()
