...
namespace ENTiger.ENCollect.Migrations.MySql.Migrations
{
    ...
    [Migration("20250625111448_AccountProductMappingAdded")]
    partial class AccountProductMappingAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENTiger.ENCollect.AccountScopeConfiguration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(60), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(114), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(130), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(132), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(140), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(142), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(149), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 25, 16, 44, 44, 902, DateTimeKind.Unspecified).AddTicks(150), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        });
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTrigger", b =>
                {
                    ...
                    b.Property<int>("MaximumOccurences")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTriggerTemplate", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("varchar(32)");
                    ...
                    b.ToTable("CommunicationTriggerTemplate");
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.CommunicationTrigger", b =>
                {
                    b.HasOne("ENTiger.ENCollect.CategoryItem", "TriggerType")
                        .WithMany()
