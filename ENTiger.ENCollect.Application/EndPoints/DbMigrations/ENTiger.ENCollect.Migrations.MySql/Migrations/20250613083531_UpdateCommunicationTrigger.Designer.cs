...
namespace ENTiger.ENCollect.Migrations.MySql.Migrations
{
    ...
    [Migration("20250613083531_UpdateCommunicationTrigger")]
    partial class UpdateCommunicationTrigger
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ENTiger.ENCollect.AccountScopeConfiguration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8465), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8556), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8589), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8596), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8622), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8628), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8653), new TimeSpan(0, 5, 30, 0, 0)),
                            IsDeleted = false,
                            LastModifiedDate = new DateTimeOffset(new DateTime(2025, 6, 13, 14, 5, 24, 810, DateTimeKind.Unspecified).AddTicks(8659), new TimeSpan(0, 5, 30, 0, 0)),
                            Scope = "all",
                            ScopeLevel = 1
                        });
                });
            ...
            modelBuilder.Entity("ENTiger.ENCollect.LoanAccountsProjection", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LatestBPTPDate")
                        .HasColumnType("datetime(6)");
