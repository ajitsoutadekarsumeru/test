...
('HL04','Country',1, 'Geo', NOW(), NOW(),0),
('HL05','Region',2, 'Geo', NOW(), NOW(),0),
('HL06','State',3, 'Geo', NOW(), NOW(),0),
('HL07','City',4, 'Geo', NOW(), NOW(),0),
('HL08','Branch',5, 'Geo', NOW(), NOW(),0);
