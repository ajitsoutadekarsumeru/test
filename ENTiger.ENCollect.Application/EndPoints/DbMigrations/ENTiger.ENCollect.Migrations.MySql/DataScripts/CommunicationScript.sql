...
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'English','Languages',NULL,'English','English',0);
 
INSERT INTO categoryitem(Id,IsDeleted,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate,Name,categorymasterId,ParentId,Code,Description,IsDisabled)
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'Tamil','Languages',NULL,'Tamil','Tamil',0);
 
INSERT INTO categoryitem(Id,IsDeleted,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate,Name,categorymasterId,ParentId,Code,Description,IsDisabled)
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'Telugu','Languages',NULL,'Telugu','Telugu',0);
 
INSERT INTO categoryitem(Id,IsDeleted,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate,Name,categorymasterId,ParentId,Code,Description,IsDisabled)
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'Kannada','Languages',NULL,'Kannada','Kannada',0);
 
INSERT INTO categoryitem(Id,IsDeleted,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate,Name,categorymasterId,ParentId,Code,Description,IsDisabled)
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'Hindi','Languages',NULL,'Hindi','Hindi',0);
 
INSERT INTO categoryitem(Id,IsDeleted,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate,Name,categorymasterId,ParentId,Code,Description,IsDisabled)
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'Malayalam','Languages',NULL,'Malayalam','Malayalam',0);
 
INSERT INTO categoryitem(Id,IsDeleted,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate,Name,categorymasterId,ParentId,Code,Description,IsDisabled)
VALUES(replace(UUID(),'-',''),0,NULL,NOW(),NULL,NOW(),'Marathi','Languages',NULL,'Marathi','Marathi',0);

INSERT INTO TriggerType (Id, Name, IsActive,Description,CreatedDate,LastModifiedDate,IsDeleted) 
VALUES 
(replace(UUID(),'-',''), 'On Xth day before due date', '1', 'Send communication X days before payment is due', NOW(), NOW(), '0'),
(replace(UUID(),'-',''), 'On Xth day after statement date', '1', 'Send communication X days after statement is generated', NOW(), NOW(), '0'),
(replace(UUID(),'-',''), 'On X DPD', '1', 'Send communication when account is X days past due',NOW(), NOW(), '0'),
(replace(UUID(),'-',''), 'On PTP Date', '1', 'Send communication on promise to pay date', NOW(), NOW(), '0'),
(replace(UUID(),'-',''), 'On Broken PTP', '1', 'Send communication when promise to pay is broken', NOW(), NOW(), '0'),
(replace(UUID(),'-',''), 'On Agency allocation change', '1', 'Send communication when account is transferred to a new agency',NOW(), NOW(), '0');
