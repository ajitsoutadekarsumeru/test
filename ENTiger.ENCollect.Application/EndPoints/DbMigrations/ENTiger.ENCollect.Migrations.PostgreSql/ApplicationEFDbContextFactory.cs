...
namespace ENTiger.ENCollect
{
    public class ApplicationEFDbContextFactory : IDesignTimeDbContextFactory<ApplicationEFDbMigrationContext>
    {
        ...
        {
            System.Diagnostics.Trace.WriteLine("Hello, EBusiness.Migrations.PostgreSql Factory! ");
            ...
            services.AddFlexBase(new List<AssembliesToLoad> { new AssembliesToLoad("ENTiger.ENCollect*.dll") });
            ...
            return new ApplicationEFDbMigrationContext(serviceProvider, config, flexHost);
        }
    }
}