...
using ENTiger.ENCollect.CronJobs.Collection;
...
internal class Program
{
    ...
    {
        Console.Title = "UpdatePaymentStatus";
        IHost host = Host.CreateDefaultBuilder(args)
                .ConfigureCommonHost
                    (
                        new ConfigureEndPointHostParams
                        {
                            HostName = "ENTiger.ENCollect.EndPoint.CronJob.UpdatePaymentStatus",
                ...
                {
                    services.AddHostedService<UpdatePaymentStatusCronJob>();
