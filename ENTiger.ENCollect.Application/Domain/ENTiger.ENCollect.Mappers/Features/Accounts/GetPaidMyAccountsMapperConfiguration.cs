...
namespace ENTiger.ENCollect.AccountsModule
{
    ...
    ///
    /// </summary>
    public partial class GetPaidMyAccountsMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public GetPaidMyAccountsMapperConfiguration() : base()
        {
            CreateMap<LoanAccount, GetPaidMyAccountsDto>()
