...
namespace ENTiger.ENCollect.AccountsModule
{
    ...
    ///
    /// </summary>
    public partial class GetUnAttemptedMyAccountsMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public GetUnAttemptedMyAccountsMapperConfiguration() : base()
        {
            CreateMap<LoanAccount, GetUnAttemptedMyAccountsDto>()
