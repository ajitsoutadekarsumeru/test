...
namespace ENTiger.ENCollect.TreatmentModule
{
    ...
    ///
    /// </summary>
    public partial class UpdateTreatmentMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public UpdateTreatmentMapperConfiguration() : base()
        {
            ...
            CreateMap<TreatmentAndSegmentMapping, TreatmentAndSegmentInputDto>()
            .ForMember(cm => cm.SegmentId, Dm => Dm.MapFrom(dModel => dModel.SegmentId));
            CreateMap<TreatmentOnPOS, TreatmentOnPOSInputDto>()
            ...
            CreateMap<TreatmentOnAccount, TreatmentOnAccountInputDto>()
            .ForMember(cm => cm.DepartmentId, Dm => Dm.MapFrom(dModel => dModel.DepartmentId))
            .ForMember(cm => cm.DesignationId, Dm => Dm.MapFrom(dModel => dModel.DesignationId))
            .ForMember(cm => cm.Percentage, Dm => Dm.MapFrom(dModel => dModel.Percentage))
            .ForMember(cm => cm.AllocationId, Dm => Dm.MapFrom(dModel => dModel.AllocationId));
            CreateMap<RoundRobinTreatment, RoundRobinTreatmentInputDto>()
            .ForMember(cm => cm.AllocationId, Dm => Dm.MapFrom(dModel => dModel.AllocationId));
            CreateMap<TreatmentByRule, TreatmentByRuleInputDto>()
            .ForMember(cm => cm.Id, Dm => Dm.MapFrom(dModel => dModel.Id))
            .ForMember(cm => cm.DepartmentId, Dm => Dm.MapFrom(dModel => dModel.DepartmentId))
            .ForMember(cm => cm.DesignationId, Dm => Dm.MapFrom(dModel => dModel.DesignationId))
            .ForMember(cm => cm.Rule, Dm => Dm.MapFrom(dModel => dModel.Rule));

            CreateMap<TreatmentOnUpdateTrail, TreatmentOnUpdateTrailInputDto>()
            .ForMember(cm => cm.Id, Dm => Dm.MapFrom(dModel => dModel.Id))
            ...
            CreateMap<TreatmentOnCommunication, TreatmentOnCommunicationInputDto>()
            .ForMember(cm => cm.Id, Dm => Dm.MapFrom(dModel => dModel.Id))
            ...
            CreateMap<TreatmentQualifyingStatus, TreatmentQualifyingStatusInputDto>()
            .ForMember(cm => cm.Id, Dm => Dm.MapFrom(dModel => dModel.Id))
            ...
            CreateMap<TreatmentOnPerformanceBand, TreatmentOnPerformanceBandInputDto>()
            .ForMember(cm => cm.Id, Dm => Dm.MapFrom(dModel => dModel.Id))
            ...
            CreateMap<TreatmentDesignation, TreatmentDesignationInputDto>()
            .ForMember(cm => cm.Id, Dm => Dm.MapFrom(dModel => dModel.Id))
            .ForMember(cm => cm.DepartmentId, Dm => Dm.MapFrom(dModel => dModel.DepartmentId))
            .ForMember(cm => cm.DesignationId, Dm => Dm.MapFrom(dModel => dModel.DesignationId));
            ...
            CreateMap<SubTreatment, SubTreatmentsInputDto>()
