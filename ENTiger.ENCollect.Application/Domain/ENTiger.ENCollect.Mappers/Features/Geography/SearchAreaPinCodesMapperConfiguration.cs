...
namespace ENTiger.ENCollect.GeographyModule
{
    ...
    ///
    /// </summary>
    public partial class SearchAreaPinCodesMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public SearchAreaPinCodesMapperConfiguration() : base()
        {
            CreateMap<AreaPinCodeMapping, SearchAreaPinCodesDto>()
