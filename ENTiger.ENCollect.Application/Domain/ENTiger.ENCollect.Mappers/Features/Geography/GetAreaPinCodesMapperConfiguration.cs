...
namespace ENTiger.ENCollect.GeographyModule
{
    ...
    ///
    /// </summary>
    public partial class GetAreaPinCodesMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public GetAreaPinCodesMapperConfiguration() : base()
        {
            CreateMap<AreaPinCodeMapping, GetAreaPinCodesDto>()
