...
namespace ENTiger.ENCollect.GeographyModule
{
    ...
    ///
    /// </summary>
    public partial class GetAreasByCityIdMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public GetAreasByCityIdMapperConfiguration() : base()
        {
            CreateMap<Area, GetAreasByCityIdDto>()
