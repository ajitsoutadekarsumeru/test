...
namespace ENTiger.ENCollect.AllocationModule
{
    ...
    ///
    /// </summary>
    public partial class GetSecondaryAllocationAccountsMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public GetSecondaryAllocationAccountsMapperConfiguration() : base()
        {
            CreateMap<LoanAccount, GetSecondaryAllocationAccountsDto>()
