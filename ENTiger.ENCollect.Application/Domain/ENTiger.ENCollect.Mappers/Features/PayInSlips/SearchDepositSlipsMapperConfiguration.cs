...
namespace ENTiger.ENCollect.PayInSlipsModule
{
    ...
    ///
    /// </summary>
    public partial class SearchDepositSlipsMapperConfiguration : FlexMapperProfile
    {
        /// <summary>
        ///
        /// </summary>
        public SearchDepositSlipsMapperConfiguration() : base()
        {
            CreateMap<Collection, SearchDepositSlipsDto>()
