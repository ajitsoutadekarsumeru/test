...
namespace ENTiger.ENCollect
{
    ...
    public partial class PrimaryAllocationFile : DomainModelBridge
    {
        ...
        /// <returns></returns>
        public virtual PrimaryAllocationFile PrimaryAllocationByBatch(PrimaryAllocationByBatchCommand cmd, string path)
        {
            Guard.AgainstNull("PrimaryAllocationFile command cannot be empty", cmd);
