...
namespace ENTiger.ENCollect
{
    ...
    public partial class Segmentation : DomainModelBridge
    {
        ...
        /// <returns></returns>
        public virtual Segmentation AddSegment(AddSegmentCommand cmd)
        {
            Guard.AgainstNull("Segmentation command cannot be empty", cmd);
            ...
            this.SegmentAdvanceFilter.SetAdded(cmd.Dto.GetGeneratedId());
