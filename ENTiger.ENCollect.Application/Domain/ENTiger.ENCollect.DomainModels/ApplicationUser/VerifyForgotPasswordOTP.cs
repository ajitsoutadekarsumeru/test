...
namespace ENTiger.ENCollect
{
    ...
    public partial class ApplicationUser : PersonBridge
    {
        ...
        /// <returns></returns>
        public virtual ApplicationUser VerifyForgotPasswordOTP(VerifyForgotPasswordOTPCommand cmd)
        {
            Guard.AgainstNull("ApplicationUser command cannot be empty", cmd);
