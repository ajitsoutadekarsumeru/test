...
namespace ENTiger.ENCollect
{
    ...
    public partial class PayInSlip : DomainModelBridge
    {
        ...
        /// <returns></returns>
        public virtual PayInSlip AckPayInSlip(AckPayInSlipCommand cmd)
        {
            Guard.AgainstNull("PayInSlip model cannot be empty", cmd);
            //this.Convert(cmd.Dto);
            this.PayInSlipWorkflowState = _flexHost.GetFlexStateInstance<PayInslipAcknowledged>().SetTFlexId(this.Id).SetStateChangedBy(this.CreatedBy ?? "");
