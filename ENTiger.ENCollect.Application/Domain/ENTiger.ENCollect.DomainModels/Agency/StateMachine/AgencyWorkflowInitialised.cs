...
{
    public class AgencyWorkflowInitialised : AgencyWorkflowState
    {
        private IFlexHost _flexHost;

        public AgencyWorkflowInitialised()
        {
        ...
        public override AgencyWorkflowState SaveAsDraft()
        {
            return _flexHost.GetFlexStateInstance<AgencySavedAsDraft>();
        }
