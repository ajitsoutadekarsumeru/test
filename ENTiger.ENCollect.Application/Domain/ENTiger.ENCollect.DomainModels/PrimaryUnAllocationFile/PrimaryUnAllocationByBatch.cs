...
namespace ENTiger.ENCollect
{
    ...
    public partial class PrimaryUnAllocationFile : DomainModelBridge
    {
        ...
        /// <returns></returns>
        public virtual PrimaryUnAllocationFile PrimaryUnAllocationByBatch(PrimaryUnAllocationByBatchCommand cmd,string filePath)
        {
            Guard.AgainstNull("PrimaryUnAllocationFile command cannot be empty", cmd);
