...
namespace ENTiger.ENCollect
{
    ...
    public partial class AllocationDownload : DomainModelBridge
    {
        ...
        /// <returns></returns>
        public virtual AllocationDownload SearchAccountsForSecondaryAllocation(SearchAccountsForSecondaryAllocationCommand cmd)
        {
            Guard.AgainstNull("AllocationDownload command cannot be empty", cmd);
