...
namespace ENTiger.ENCollect.CompanyUsersModule.ApproveCompanyUserCompanyUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class CheckCreatedBy : FlexiBusinessRuleBase, IFlexiBusinessRule<ApproveCompanyUserDataPacket>
    {
        public override string Id { get; set; } = "3a12da55818b1afc29c4472b7932ee71";
