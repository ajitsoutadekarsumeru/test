...
namespace ENTiger.ENCollect.AgencyUsersModule.GetAgentImageAgencyUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class ValidateFile : FlexiBusinessRuleBase, IFlexiBusinessRule<GetAgentImageDataPacket>
    {
        public override string Id { get; set; } = "3a13ba414a142d8d8f04f1c70cf62d85";
