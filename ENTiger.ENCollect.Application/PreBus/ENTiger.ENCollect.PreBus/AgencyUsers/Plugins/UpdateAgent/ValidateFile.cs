...
namespace ENTiger.ENCollect.AgencyUsersModule.UpdateAgentAgencyUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class ValidateFile : FlexiBusinessRuleBase, IFlexiBusinessRule<UpdateAgentDataPacket>
    {
        ...
        private void ValidateProfileImage(UpdateAgentDataPacket packet)
        {
        ...
        /// <returns>Asynchronous task.</returns>
        private async void ValidateAgentProfileIdentificationAsync(UpdateAgentDataPacket packet)
        {
