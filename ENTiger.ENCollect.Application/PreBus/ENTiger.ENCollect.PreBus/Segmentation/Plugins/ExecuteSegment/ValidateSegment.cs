...
namespace ENTiger.ENCollect.SegmentationModule.ExecuteSegmentSegmentationPlugins
{
    /// <summary>
    /// 
    /// </summary>
    public partial class ValidateSegment : FlexiBusinessRuleBase, IFlexiBusinessRule<ExecuteSegmentDataPacket>
    {
        public override string Id { get; set; } = "3a145c6984f8e80d0813692669ce91d7";
        ...
        public virtual async Task Validate(ExecuteSegmentDataPacket packet)
        {
