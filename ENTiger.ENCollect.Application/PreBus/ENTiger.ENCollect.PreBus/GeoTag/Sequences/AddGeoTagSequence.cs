...
using Sumeru.Flex;
using ENTiger.ENCollect.GeoTagModule.AddGeoTagGeoTagPlugins;
...
namespace ENTiger.ENCollect.GeoTagModule
{
    ...
    /// 
    /// </summary>
    public class AddGeoTagSequence : FlexiBusinessRuleSequenceBase<AddGeoTagDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public AddGeoTagSequence()
        {
            
            this.Add<ValidateGeoTag>(); 
        }
    }
}
