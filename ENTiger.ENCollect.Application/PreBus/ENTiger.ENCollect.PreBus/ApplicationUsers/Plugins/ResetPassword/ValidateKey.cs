...
namespace ENTiger.ENCollect.ApplicationUsersModule.ResetPasswordApplicationUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class ValidateKey : FlexiBusinessRuleBase, IFlexiBusinessRule<ResetPasswordDataPacket>
    {
        public override string Id { get; set; } = "3a1343f20966b3e57fb05014027433d1";
