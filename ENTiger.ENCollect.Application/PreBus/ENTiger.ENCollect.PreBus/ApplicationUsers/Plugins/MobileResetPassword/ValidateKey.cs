...
namespace ENTiger.ENCollect.ApplicationUsersModule.MobileResetPasswordApplicationUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class ValidateKey : FlexiBusinessRuleBase, IFlexiBusinessRule<MobileResetPasswordDataPacket>
    {
        public override string Id { get; set; } = "3a1343f31089ce5b9c6843ed3ab82f5b";
