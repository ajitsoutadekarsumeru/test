...
namespace ENTiger.ENCollect.ApplicationUsersModule.LoginApplicationUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class ValidateKey : FlexiBusinessRuleBase, IFlexiBusinessRule<LoginDataPacket>
    {
        public override string Id { get; set; } = "3a12e5dde1d310d63a0a590feec5802a";
        ...
        public async Task validate(FlexiFlowDataPacket packet, string Id)
        {
            ...
            var result = await _repoFactory.GetRepo().FindAll<UserLoginKeys>().Where(x => x.Id == Id).FirstOrDefaultAsync();
            if (result != null)
            {
