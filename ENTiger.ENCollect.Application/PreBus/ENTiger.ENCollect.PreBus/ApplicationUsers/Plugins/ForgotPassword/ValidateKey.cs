...
namespace ENTiger.ENCollect.ApplicationUsersModule.ForgotPasswordApplicationUsersPlugins
{
    ...
    /// 
    /// </summary>
    public partial class ValidateKey : FlexiBusinessRuleBase, IFlexiBusinessRule<ForgotPasswordDataPacket>
    {
        public override string Id { get; set; } = "3a133db322ef61e74b6189b57f5a04d5";
