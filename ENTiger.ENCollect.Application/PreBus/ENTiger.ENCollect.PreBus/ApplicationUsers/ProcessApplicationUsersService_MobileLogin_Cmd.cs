...
namespace ENTiger.ENCollect.ApplicationUsersModule
{
    ...
    {
        protected virtual async Task ProcessCommand(MobileLoginCommand cmd)
        {

            MobileLoginPostBusDataPacket packet = _flexHost.GetFlexiFlowDataPacket<MobileLoginPostBusDataPacket>();

            //Fill your data to datapacket here
            packet.Cmd = cmd;

            FlexiPluginSequenceBase<MobileLoginPostBusDataPacket> sequence = _flexHost.GetFlexiPluginSequence<MobileLoginPostBusSequence, MobileLoginPostBusDataPacket>();
