...
namespace ENTiger.ENCollect.ApplicationUsersModule
{
    ...
    {
        protected virtual async Task ProcessCommand(VerifyLoginOTPCommand cmd)
        {

            VerifyLoginOTPPostBusDataPacket packet = _flexHost.GetFlexiFlowDataPacket<VerifyLoginOTPPostBusDataPacket>();

            //Fill your data to datapacket here
            packet.Cmd = cmd;

            FlexiPluginSequenceBase<VerifyLoginOTPPostBusDataPacket> sequence = _flexHost.GetFlexiPluginSequence<VerifyLoginOTPPostBusSequence, VerifyLoginOTPPostBusDataPacket>();
