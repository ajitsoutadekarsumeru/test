...
namespace ENTiger.ENCollect.ApplicationUsersModule
{
    ...
    {
        protected virtual async Task ProcessCommand(ChangePasswordCommand cmd)
        {

            ChangePasswordPostBusDataPacket packet = _flexHost.GetFlexiFlowDataPacket<ChangePasswordPostBusDataPacket>();

            //Fill your data to datapacket here
            packet.Cmd = cmd;

            FlexiPluginSequenceBase<ChangePasswordPostBusDataPacket> sequence = _flexHost.GetFlexiPluginSequence<ChangePasswordPostBusSequence, ChangePasswordPostBusDataPacket>();
