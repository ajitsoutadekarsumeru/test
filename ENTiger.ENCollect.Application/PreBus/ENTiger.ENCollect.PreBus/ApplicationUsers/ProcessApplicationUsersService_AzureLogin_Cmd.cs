...
namespace ENTiger.ENCollect.ApplicationUsersModule
{
    ...
    {
        protected virtual async Task ProcessCommand(AzureLoginCommand cmd)
        {

            AzureLoginPostBusDataPacket packet = _flexHost.GetFlexiFlowDataPacket<AzureLoginPostBusDataPacket>();

            //Fill your data to datapacket here
            packet.Cmd = cmd;

            FlexiPluginSequenceBase<AzureLoginPostBusDataPacket> sequence = _flexHost.GetFlexiPluginSequence<AzureLoginPostBusSequence, AzureLoginPostBusDataPacket>();
