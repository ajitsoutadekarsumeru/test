...
namespace ENTiger.ENCollect.CommonModule
{
    ...
    {
        protected virtual async Task ProcessCommand(GetLogoCommand cmd)
        {

            GetLogoPostBusDataPacket packet = _flexHost.GetFlexiFlowDataPacket<GetLogoPostBusDataPacket>();

            //Fill your data to datapacket here
            packet.Cmd = cmd;

            FlexiPluginSequenceBase<GetLogoPostBusDataPacket> sequence = _flexHost.GetFlexiPluginSequence<GetLogoPostBusSequence, GetLogoPostBusDataPacket>();
