...
namespace ENTiger.ENCollect.CollectionsModule.AddCollectionCancellationCollectionsPlugins
{
    /// <summary>
    /// 
    /// </summary>
    public partial class ValidateCollection : FlexiBusinessRuleBase, IFlexiBusinessRule<AddCollectionCancellationDataPacket>
    {
        public override string Id { get; set; } = "3a136f58c7e5c320c719b8ffd6bdc020";
        ...
        public virtual async Task Validate(AddCollectionCancellationDataPacket packet)
        {
