...
{
    public partial class CheckUserCollectionLimit : FlexiBusinessRuleBase, IFlexiBusinessRule<AddCollectionDataPacket>
    {
        ...
        protected readonly ILogger<CheckUserCollectionLimit> _logger;
        protected readonly IRepoFactory _repoFactory;
        protected FlexAppContextBridge? _flexAppContext;
        private readonly ILicenseService _licenseService;
        protected readonly IFlexServiceBusBridge _bus;

        public CheckUserCollectionLimit(ILogger<CheckUserCollectionLimit> logger, IRepoFactory repoFactory, ILicenseService licenseService, IFlexServiceBusBridge bus)
        {
            _logger = logger;
