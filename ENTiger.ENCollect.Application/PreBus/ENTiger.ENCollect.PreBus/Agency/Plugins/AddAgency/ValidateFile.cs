...
namespace ENTiger.ENCollect.AgencyModule.AddAgencyAgencyPlugins
{
    ...
    /// </summary>
    public partial class ValidateFile : FlexiBusinessRuleBase, IFlexiBusinessRule<AddAgencyDataPacket>
    {
        /// <summary>
        ...
        /// <returns>Asynchronous task.</returns>
        private async void ValidateAgencyProfileIdentificationAsync(AddAgencyDataPacket packet)
        {
