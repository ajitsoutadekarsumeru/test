...
namespace ENTiger.ENCollect.DevicesModule.VerifyRegisteredDeviceDevicesPlugins
{
    ...
    /// </summary>
    public partial class ValidateKey : FlexiBusinessRuleBase, IFlexiBusinessRule<VerifyRegisteredDeviceDataPacket>
    {
        ...
        /// </summary>
        private async Task<string> ValidateReferenceKeyAsync(VerifyRegisteredDeviceDataPacket packet, string referenceId)
        {
