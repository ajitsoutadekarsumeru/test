...
namespace ENTiger.ENCollect.DevicesModule.RegisterDeviceDevicesPlugins
{
    ...
    /// </summary>
    public partial class VerifyUser : FlexiBusinessRuleBase, IFlexiBusinessRule<RegisterDeviceDataPacket>
    {
        ...
        private void LogAndAddError(RegisterDeviceDataPacket packet, string userMessage, string logMessage)
        {
        ...
        /// </summary>
        private void DecryptSensitiveFields(RegisterDeviceDataPacket packet)
        {
            var dto = packet.Dto;
