...
public partial class UpdateLoanAccountsProjectionOnCollectionSuccess : IUpdateLoanAccountsProjectionOnCollectionSuccess
{
    private readonly ILogger<UpdateLoanAccountsProjectionOnCollectionSuccess> _logger;
    private readonly IRepoFactory _repoFactory;

    private FlexAppContextBridge? _flexAppContext;
    private const string EventCondition = ""; // Event condition

    public UpdateLoanAccountsProjectionOnCollectionSuccess(
        ILogger<UpdateLoanAccountsProjectionOnCollectionSuccess> logger,
    ...
    public virtual async Task Execute(CollectionSuccessEvent @event, IFlexServiceBusContext serviceBusContext)
    {
