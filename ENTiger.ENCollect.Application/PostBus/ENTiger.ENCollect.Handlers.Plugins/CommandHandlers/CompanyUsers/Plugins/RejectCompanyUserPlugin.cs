...
namespace ENTiger.ENCollect.CompanyUsersModule
{
    ...
    {
        public override string Id { get; set; } = "3a12da57969b64bc9af71b46599f1e06";
        public override string FriendlyName { get; set; } = "RejectCompanyUserPlugin";

        protected string EventCondition = "";

        protected readonly ILogger<RejectCompanyUserPlugin> _logger;
        ...
        public RejectCompanyUserPlugin(ILogger<RejectCompanyUserPlugin> logger, IFlexHost flexHost, IRepoFactory repoFactory, IDiffGenerator diffGenerator)
        {
            _logger = logger;
            _flexHost = flexHost;
        ...
        public virtual async Task Execute(RejectCompanyUserPostBusDataPacket packet)
        {
            ...
            if (_model != null)
            {
                ...
                {
                    obj.RejectCompanyUser(_flexAppContext?.UserId, packet.Cmd.Dto.description);
        ...
        private async Task GenerateAndSendAuditEventAsync(RejectCompanyUserPostBusDataPacket packet)
        {
            string jsonPatch;
            foreach (var obj in _model)
            {
