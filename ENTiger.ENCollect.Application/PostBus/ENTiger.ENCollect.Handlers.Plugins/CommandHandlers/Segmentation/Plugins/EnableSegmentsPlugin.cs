...
{
    public partial class EnableSegmentsPlugin : FlexiPluginBase, IFlexiPlugin<EnableSegmentsPostBusDataPacket>
    {
        public override string Id { get; set; } = "3a1458c75933e811fe2d9e33b021ebd3";
        public override string FriendlyName { get; set; } = "EnableSegmentsPlugin";

        protected string EventCondition = "";

        protected readonly ILogger<EnableSegmentsPlugin> _logger;
        ...
        public EnableSegmentsPlugin(ILogger<EnableSegmentsPlugin> logger, IFlexHost flexHost, IRepoFactory repoFactory)
        {
            _logger = logger;
            _flexHost = flexHost;
        ...
        public virtual async Task Execute(EnableSegmentsPostBusDataPacket packet)
        {
            ...
            foreach (var item in packet.Cmd.Dto.SegmentIds)
            {
                ...
                if (_model != null)
                {
                    _model.EnableSegments(packet.Cmd, item);
