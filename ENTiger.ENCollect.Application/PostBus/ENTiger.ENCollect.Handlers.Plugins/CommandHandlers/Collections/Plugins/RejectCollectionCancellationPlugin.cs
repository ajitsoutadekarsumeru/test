...
namespace ENTiger.ENCollect.CollectionsModule
{
    ...
    {
        public override string Id { get; set; } = "3a136f5aced1836de6f3ebad22fa9a03";
        public override string FriendlyName { get; set; } = "RejectCollectionCancellationPlugin";

        protected string EventCondition = "";

        protected readonly ILogger<RejectCollectionCancellationPlugin> _logger;
        ...
        public RejectCollectionCancellationPlugin(ILogger<RejectCollectionCancellationPlugin> logger, IFlexHost flexHost, IRepoFactory repoFactory, IDiffGenerator diffGenerator)
        {
            _logger = logger;
            _flexHost = flexHost;
        ...
        public virtual async Task Execute(RejectCollectionCancellationPostBusDataPacket packet)
        {
            ...
            foreach (Collection collection in collections)
            {
                ...
                collection.MarkAsCancellationRejected(userid);
        ...
        private async Task GenerateAndSendAuditEventAsync(RejectCollectionCancellationPostBusDataPacket packet)
        {
        ...
        {
            _logger.LogDebug("CollectionCancellationRejectedCommandHandler : FetchCollections - Start");
            ...
            _logger.LogInformation("CollectionCancellationRejectedCommandHandler : Collections - Count : " + collections.Count());
            _logger.LogDebug("CollectionCancellationRejectedCommandHandler : FetchCollections - End");
        }
    }
}