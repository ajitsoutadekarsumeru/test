...
{
    public partial class UpdatePayInSlipPlugin : FlexiPluginBase, IFlexiPlugin<UpdatePayInSlipPostBusDataPacket>
    {
        public override string Id { get; set; } = "3a138650d084193d087b33b6605c4c06";
        public override string FriendlyName { get; set; } = "UpdatePayInSlipPlugin";

        protected string EventCondition = "";

        protected readonly ILogger<UpdatePayInSlipPlugin> _logger;
        ...
        public UpdatePayInSlipPlugin(ILogger<UpdatePayInSlipPlugin> logger, IFlexHost flexHost, IRepoFactory repoFactory)
        {
            _logger = logger;
            _flexHost = flexHost;
        ...
        public virtual async Task Execute(UpdatePayInSlipPostBusDataPacket packet)
        {
            ...
            if (_model != null)
            {
                _model.UpdatePayInSlip(packet.Cmd);
