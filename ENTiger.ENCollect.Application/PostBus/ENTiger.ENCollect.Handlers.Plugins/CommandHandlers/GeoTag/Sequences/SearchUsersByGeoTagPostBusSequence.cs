...
namespace ENTiger.ENCollect.GeoTagModule
{
    ...
    /// 
    /// </summary>
    public class SearchUsersByGeoTagPostBusSequence : FlexiPluginSequenceBase<SearchUsersByGeoTagPostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public SearchUsersByGeoTagPostBusSequence()
        {
            this.Add<SearchUsersByGeoTagPlugin>(); 
        }
    }
}
