...
namespace ENTiger.ENCollect.GeoTagModule
{
    ...
    /// 
    /// </summary>
    public class AddLoginGeoTagPostBusSequence : FlexiPluginSequenceBase<AddLoginGeoTagPostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public AddLoginGeoTagPostBusSequence()
        {
            this.Add<AddLoginGeoTagPlugin>(); 
        }
    }
}
