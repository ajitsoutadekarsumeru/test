...
namespace ENTiger.ENCollect.SettlementModule
{
    ...
    {
        public override string Id { get; set; } = "3a19505791e262cee3b141609b465et3";
        public override string FriendlyName { get; set; } = "RequestSettlementPlugin";
        
        protected string EventCondition = "";

        protected readonly ILogger<ProcessSettlementCustomerRejectPlugin> _logger;
        ...
        public ProcessSettlementCustomerRejectPlugin(ILogger<ProcessSettlementCustomerRejectPlugin> logger, 
        ...
        public virtual async Task Execute(ProcessSettlementCustomerRejectPostBusDataPacket packet)
        {
            ...
            var cmd = packet.Cmd;           
            var _settlementId = cmd.DomainId;
            ...
            _model = await _settlementRepository.GetByIdAsync(_flexAppContext, _settlementId);
            if (_model == null) throw new InvalidOperationException("Settlement not found");

            // 2) Update Status
            _model.ChangeStatus(SettlementStatusEnum.CustomerRejectedOffer.Value, 
                cmd.UserId, dto);
