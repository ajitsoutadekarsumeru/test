...
namespace ENTiger.ENCollect.SettlementModule
{
    public partial class ProcessSettlementRejectPlugin : FlexiPluginBase, IFlexiPlugin<ProcessSettlementRejectPostBusDataPacket>
    {
        ...
        protected readonly ILogger<ProcessSettlementRejectPlugin> _logger;
        ...
        public ProcessSettlementRejectPlugin(ILogger<ProcessSettlementRejectPlugin> logger, 
        ...
        public virtual async Task Execute(ProcessSettlementRejectPostBusDataPacket packet)
        {
            ...
            // 2) Update Status
            _model.ChangeStatus(SettlementStatusEnum.RequestRejected.Value, 
                cmd.UserId, dto);
