...
namespace ENTiger.ENCollect.CollectionBatchesModule
{
    ...
    /// 
    /// </summary>
    public class AcknowledgeCollectionBatchPostBusSequence : FlexiPluginSequenceBase<AcknowledgeCollectionBatchPostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public AcknowledgeCollectionBatchPostBusSequence()
        {
            this.Add<AcknowledgeCollectionBatchPlugin>(); 
        }
    }
}
