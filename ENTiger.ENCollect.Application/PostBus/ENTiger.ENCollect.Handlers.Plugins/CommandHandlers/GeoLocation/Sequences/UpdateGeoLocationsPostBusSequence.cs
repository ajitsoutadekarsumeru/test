...
namespace ENTiger.ENCollect.GeoLocationModule
{
    ...
    /// 
    /// </summary>
    public class UpdateGeoLocationsPostBusSequence : FlexiPluginSequenceBase<UpdateGeoLocationsPostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public UpdateGeoLocationsPostBusSequence()
        {
            this.Add<UpdateGeoLocationsPlugin>(); 
        }
    }
}
