...
namespace ENTiger.ENCollect.PermissionSchemesModule
{
    ...
    /// 
    /// </summary>
    public class CreatePermissionSchemePostBusSequence : FlexiPluginSequenceBase<CreatePermissionSchemePostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public CreatePermissionSchemePostBusSequence()
        {
            this.Add<CreatePermissionSchemePlugin>(); 
        }
    }
}
