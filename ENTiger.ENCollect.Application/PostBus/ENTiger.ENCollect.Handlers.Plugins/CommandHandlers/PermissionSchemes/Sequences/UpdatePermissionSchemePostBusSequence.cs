...
namespace ENTiger.ENCollect.PermissionSchemesModule
{
    ...
    /// 
    /// </summary>
    public class UpdatePermissionSchemePostBusSequence : FlexiPluginSequenceBase<UpdatePermissionSchemePostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public UpdatePermissionSchemePostBusSequence()
        {
            this.Add<UpdatePermissionSchemePlugin>(); 
        }
    }
}
