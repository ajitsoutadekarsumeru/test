...
namespace ENTiger.ENCollect.AgencyModule
{
    ...
    {
        public override string Id { get; set; } = "3a13182601d2071d98a56fa7256365ce";
        public override string FriendlyName { get; set; } = "ApproveAgencyWithDeferralPlugin";

        protected string EventCondition = "";

        protected readonly ILogger<ApproveAgencyWithDeferralPlugin> _logger;
        ...
        public ApproveAgencyWithDeferralPlugin(ILogger<ApproveAgencyWithDeferralPlugin> logger, IFlexHost flexHost, IRepoFactory repoFactory, IDiffGenerator diffGenerator)
        {
            _logger = logger;
            _flexHost = flexHost;
        ...
        public virtual async Task Execute(ApproveAgencyWithDeferralPostBusDataPacket packet)
        {
            ...
            if (_model != null)
            {
                ...
                {
                    obj.ApproveAgencyWithDeferral(_flexAppContext?.UserId);
        ...
        private async Task GenerateAndSendAuditEventAsync(ApproveAgencyWithDeferralPostBusDataPacket packet)
        {
            string jsonPatch;
            foreach (var obj in _model)
            {
