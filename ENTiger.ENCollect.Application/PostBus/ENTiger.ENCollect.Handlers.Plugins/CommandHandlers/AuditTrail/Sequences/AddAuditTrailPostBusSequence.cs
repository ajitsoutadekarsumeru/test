...
namespace ENTiger.ENCollect.AuditTrailModule
{
    ...
    /// 
    /// </summary>
    public class AddAuditTrailPostBusSequence : FlexiPluginSequenceBase<AddAuditTrailPostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public AddAuditTrailPostBusSequence()
        {
            this.Add<AddAuditTrailPlugin>(); 
        }
    }
}
