...
namespace ENTiger.ENCollect.DevicesModule
{
    ...
    /// 
    /// </summary>
    public class VerifyRegisteredDevicePostBusSequence : FlexiPluginSequenceBase<VerifyRegisteredDevicePostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public VerifyRegisteredDevicePostBusSequence()
        {
            this.Add<VerifyRegisteredDevicePlugin>(); 
        }
    }
}
