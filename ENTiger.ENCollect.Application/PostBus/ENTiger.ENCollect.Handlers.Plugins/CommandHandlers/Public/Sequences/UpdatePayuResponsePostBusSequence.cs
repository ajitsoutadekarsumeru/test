...
namespace ENTiger.ENCollect.PublicModule
{
    ...
    /// 
    /// </summary>
    public class UpdatePayuResponsePostBusSequence : FlexiPluginSequenceBase<UpdatePayuResponsePostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public UpdatePayuResponsePostBusSequence()
        {
            this.Add<UpdatePayuResponsePlugin>(); 
        }
    }
}
