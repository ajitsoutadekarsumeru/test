...
namespace ENTiger.ENCollect.PublicModule
{
    ...
    /// 
    /// </summary>
    public class ImportCollectionsPostBusSequence : FlexiPluginSequenceBase<ImportCollectionsPostBusDataPacket>
    {
        /// <summary>
        /// 
        /// </summary>
        public ImportCollectionsPostBusSequence()
        {
            this.Add<ImportCollectionsPlugin>(); 
        }
    }
}
