namespace ENTiger.ENCollect.AccountsModule
{
    ...
    ///
    /// </summary>
    public partial class GetBirdEyeViewDto : DtoBridge
    {
        public PaidTodaysQueue PaidQueue { get; set; }
        public contactsUniqueTodaysQueue contactsUniqueQueue { get; set; }
        public ConnectsUniqueTodaysQueue ConnectsUniqueQueue { get; set; }
        public Assignedviewoutputmodel assigned { get; set; }
        public PTPoutputmodel ptp { get; set; }
        public PTPoutputmodel ptpnotdue { get; set; }
        public BrokenTodaysQueue brokenptp { get; set; }
        public WorkableAccountsTodaysQueue WorkableAccounts { get; set; }
    }

    public class PaidTodaysQueue
    {
        public Int64 count { get; set; }
        public decimal? pos { get; set; }

        public ICollection<BirdEyeViewAccountSearchDto> accountdetails { get; set; }
    }

    public class contactsUniqueTodaysQueue
    {
        public Int64 count { get; set; }
        public decimal? pos { get; set; }
    ...
    public class ConnectsUniqueTodaysQueue
    {
        public Int64 count { get; set; }
        public decimal? pos { get; set; }
    ...
    public class Assignedviewoutputmodel
    {
        public Int64 count { get; set; }
        public decimal? pos { get; set; }
    ...
    public class BrokenTodaysQueue
    {
        public Int64 count { get; set; }
        public decimal? pos { get; set; }
    ...
    public class WorkableAccountsTodaysQueue
    {
        public Int64 count { get; set; }
        public decimal? pos { get; set; }
        public ICollection<BirdEyeViewAccountSearchDto> accountdetails { get; set; }
    ...
    public class BirdEyeViewAccountSearchDto
    {
    ...
    public class BirdEyeViewAccountDetailDto
    {
        public string? Id { get; set; }
