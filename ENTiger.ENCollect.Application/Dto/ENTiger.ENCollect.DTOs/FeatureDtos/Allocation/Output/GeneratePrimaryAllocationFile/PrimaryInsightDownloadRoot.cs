...
namespace ENTiger.ENCollect.AllocationModule.PrimaryAllocationInsightDownloadRoot
{
    ...
    public class Source
    {
        //public string? id_loanaccounts { get; set; }
        ...
        public string? total_overdue { get; set; }
