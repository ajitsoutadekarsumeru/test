...
namespace ENTiger.ENCollect.AllocationModule
{
    ...
    public sealed class PrimaryAllocationInsightElkResponseHitsMap : ClassMap<ENTiger.ENCollect.AllocationModule.PrimaryAllocationInsightDownloadRoot.Hits>
    {
        public PrimaryAllocationInsightElkResponseHitsMap()
        {
            ...
            Map(m => m._source.bom_current_pos_loanaccounts).Index(12).Name("Current_POS");
            Map(m => m._source.principal_od).Index(12).Name("PrincipalOverdue");
            Map(m => m._source.interest_od).Index(13).Name("InterestOverdue");
            Map(m => m._source.charge_overdue).Index(14).Name("ChargeOverdue");
            Map(m => m._source.total_overdue).Index(15).Name("TotalOverdue");
            Map(m => m._source.npa_stageid_loanaccounts).Index(16).Name("NPA_Flag");
            Map(m => m._source.amountoutstanding).Index(17).Name("AmountOutstanding");
            ...
            Map(m => m._source.primaryallocationstatusfortelecallingagency).Name("Primary_Alloc_Status_For_Telecalling_Agency");
            Map(m => m._source.primaryallocationstatusforfieldagency).Name("Primary_Alloc_Status_For_Field_Agency");
