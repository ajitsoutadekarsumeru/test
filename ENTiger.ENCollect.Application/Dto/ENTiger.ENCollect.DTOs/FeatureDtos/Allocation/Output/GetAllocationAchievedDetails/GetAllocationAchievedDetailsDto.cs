...
namespace ENTiger.ENCollect.AllocationModule
{
    ...
    /// 
    /// </summary>
    public partial class GetAllocationAchievedDetailsDto : DtoBridge
    {
        ...
        public string? Field_Agent_Name { get; set; }

        public string? Field_Agent_Custom_ID { get; set; }


        public string? Telecaller_Agent_Name { get; set; }

        public string? Telecaller_Agent_Custom_ID { get; set; }
